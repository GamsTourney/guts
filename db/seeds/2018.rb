...
Helpers.create_matches(tournament, morning_schedule, morning_start, 12.minutes, morning_games)
...
Helpers.create_matches(tournament, afternoon_schedule, afternoon_start, 8.minutes, afternoon_games)
